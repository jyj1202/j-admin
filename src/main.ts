...
app.use(router).use(pinia).use(ElementPlus).use(installGlobComponents).use(vLazyImg)
  ...
  audio: [
    {
      ...
      cover:
        'https://p2.music.126.net/PywoXPKK3AjseU0Wx9wdXw==/109951167267731534.jpg?param=130y130',
      theme: '#ebd0c2',
      artist: '坂本 龍一'
    },
    {
