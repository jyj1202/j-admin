<template>
  <div class="flex flex-col items-center">
    ...
    <el-button class="mt-10" type="primary" @click="generateDom">generate dom</el-button>
    
    <div ref="containerRef"></div>
    
    <el-button v-if="isShow" class="mt-10" type="primary" @click="generateImage">generate image</el-button>
    ...
    >
      <img :src="imgSrc" alt="">
      <el-button class="mt-10" type="primary" @click="downloadImage">downloadImage</el-button>
    </el-dialog>
  </div>
</template>
