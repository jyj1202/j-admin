<template>
  <div class="flex flex-col items-center">
    <div ref="targetRef" class="flex items-center space-x-10">
      <!-- <SvgIcon class="w-24" name="pinia"></SvgIcon> -->
    ...
    <div class="my-10 text-lime-500 border-2 p-2">
      this is the part that don't need to be transformed.
    </div>
    ...
    <el-button class="mt-10" type="primary" @click="generateImage">generate image</el-button>
    <el-dialog
...
const generateImage = async () => {
  ...
  container.appendChild(clonedAdded)
